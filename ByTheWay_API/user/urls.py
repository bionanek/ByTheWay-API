...
urlpatterns = [
    ...
    url(r'^profiles/pictures/$', views.PicturesList.as_view(), name="profile-pic-list"),
    url(r'^profiles/pictures/(?P<pk>[0-9]+)/$', views.PictureDetails.as_view(), name="profile-pic-details")
]
